        ...
        <Fragment>
            ...
            <div className="h-screen flex items-center justify-center">
                <div className="container p-8">
                    <div className="md:w-[512px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8">
                        <div className="col-span-1 md:w-64 md:h-64">
                            <Link
                                to={'/order'}
                                onClick={() => {
                                ...
                                className="py-4 md:py-0 shadow-box w-full h-full rounded-lg flex flex-col items-center justify-center bg-white"
                            >
