import { CashierIcon, ReportIcon, InvoiceIcon, RestaurantIcon } from '~/components/Icons';
            ...
            <div className="container p-8">
                <div className="grid grid-cols-12 gap-4">
                    <div className="col-span-3">
                        <Link to={'/'} className="p-4 rounded-lg flex flex-col items-center justify-center bg-white">
                    ...
                    <div className="col-span-3">
                        ...
                        >
                            <div className="p-5 rounded-full bg-[#ff8106]">
                                <ReportIcon width={48} height={48} className={'fill-white'} />
                            </div>
